...
## `Test permettant la validation de progression de l'application`

### `Prototype 1`
Ce fichier PDF n'affichais seulement le QRcode avec le titre, le texte ainsi que son lien inscrit en dessous sans personnalisation comme pourront montrer les autres prototypes
[Voir PROTOTYPE 1](Output/Autogeneratedv1.pdf)

### `Prototype 2`
Ce fichier PDF affichais la base de la personnalisation et de l'ajout d'image sans pour autant pouvoir personnalisé celle-ci
[Voir PROTOTYPE 2](Output/Autogeneratedv2.pdf)

### `Prototype 3`
Ce fichier PDF pouvais maintenant avoir une image mise à différents endroits (Droite, Centre, Gauche), il etait aussi possible de changer la taille du QRCode et de l'image
[Voir PROTOTYPE 3](Output/Autogeneratedv3.pdf)

### `Prototype 4` et `Prototype 5`
Ces fichier PDF ont maintenant les sauvegardes de profil et personnalisation avec un choix si la personnalisation doit faire parti de la sauvegarde ou non.
[Voir PROTOTYPE 4](Output/Autogeneratedv4.pdf) [Voir JSON Sans Personnalisation](Output/ProjectNoPerso.json)
[Voir PROTOTYPE 5](Output/Autogeneratedv4.pdf) [Voir JSON Avec Personnalisation](Output/ProjectPerso.json)